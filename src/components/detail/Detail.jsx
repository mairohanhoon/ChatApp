    ...
    <div className="flex-1/4 bg-gray-800 rounded-lg p-6 flex flex-col">
      ...
      <div className="text-center mb-6">
        <p className="text-gray-400 text-sm">
          Loves building chat apps and exploring new technologies. Always up for
          a good conversation about coding and innovation.
        </p>
      </div>
        ...
        <div className="bg-gray-700 rounded-lg">
          ...
          {chatSettingsOpen && (
            <div className="px-4 pb-4 space-y-2">
              <div className="text-gray-300 text-sm p-2 hover:bg-gray-600 rounded cursor-pointer">
                Mute notifications
              </div>
              <div className="text-gray-300 text-sm p-2 hover:bg-gray-600 rounded cursor-pointer">
      ...
      <div className="mt-3">
        <button
          ...
          className="w-full flex items-center justify-center p-3 bg-gray-600 hover:bg-gray-500 text-white rounded-lg transition-colors"
        >
